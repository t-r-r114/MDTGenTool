        ...
        Rectangle {
            ...
            Column {
                ...
                Column {
                    ...
                    Label { text: "降雨量:"; font.pixelSize: 12 }
                    TextField {
                    ...
                    Label { text: "侵蚀迭代次数:"; font.pixelSize: 12 }
                    TextField {
                        id: erosionsTimes
                        width: 120; height: 22
                        text: "5"
                    ...
                    Label { text: "侵蚀强度:"; font.pixelSize: 12 }
                    TextField {
                        id: erosionIntensity
                        width: 120; height: 22
                        text: "20"
                    ...
                    Label { text: "蒸发率:"; font.pixelSize: 12 }
                    TextField {
                        id: evaporationRate
                        width: 120; height: 22
                        text: "0.1"
                    ...
                    Label { text: "泥沙携带能力因子:"; font.pixelSize: 12 }
                    TextField {
                    ...
                    Label { text: "沉积率:"; font.pixelSize: 12 }
                    TextField {
                        id: depositionRate
                        width: 120; height: 22
                        text: "0.3"
                    ...
                    Label { text: "最小坡度:"; font.pixelSize: 12 }
                    TextField {
                        id: minSlope
                        width: 120; height: 22
                        text: "0.01"
